...
class _VerificationAccountState extends State<VerificationAccount> with SingleTickerProviderStateMixin {
  // Constants
  final int time = 30;
  ...
  get _getEmailLabel {
    return new Text(
      ...
      textAlign: TextAlign.center,
      style: new TextStyle(
          fontSize: 15.5, color: Colors.black, fontWeight: FontWeight.w600),
    );
  }
